...
export const episodes: EpisodeEntity[] = [
  {
    ...
    notes: [
      ...
      {text: 'Jasper v1.0.0をリリースしました🚀（GitHub用のissueリーダー）', url: 'https://blog.h13i32maru.jp/entry/2020/10/05/172043'},
      {text: 'Bdash', url: 'https://www.bdash.io/'},
      {text: '気兼ねなくアクティビティを書き留められるTrickleというサービスをリリースしました', url: 'https://blog.h13i32maru.jp/entry/2018/11/12/092904'},
